 ...
 *
 ********************************************************************/
angular.module('newApp').controller('categoriasCtrl', ['$scope', 'applicationService', '$http', '$location', '$route', '$window', '$timeout',
    function($scope, applicationService, $http, $location, $route, $window, $timeout) {
        ...
        $scope.q = '';
        $scope.row = {};
        $scope.model = 'categorias_dashboard';
        $scope.get = '';

        $scope.name_controller = 'Categorias';
